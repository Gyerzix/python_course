...
# _, binary_75 = cv2.threshold(resized_image, 75, 255, cv2.THRESH_BINARY)
# _, binary_100 = cv2.threshold(resized_image, 100, 255, cv2.THRESH_BINARY)
# _, binary_127 = cv2.threshold(resized_image, 127, 255, cv2.THRESH_BINARY)
#
# combined_75 = cv2.hconcat([resized_image, binary_75])
# combined_100 = cv2.hconcat([resized_image, binary_100])
# combined_127 = cv2.hconcat([resized_image, binary_127])
#
# cv2.namedWindow("Threshold 75", cv2.WINDOW_NORMAL)
# cv2.imshow("Threshold 75", combined_75)
#
# cv2.namedWindow("Threshold 100", cv2.WINDOW_NORMAL)
# cv2.imshow("Threshold 100", combined_100)
#
# cv2.namedWindow("Threshold 127", cv2.WINDOW_NORMAL)
# cv2.imshow("Threshold 127", combined_127)
#
# cv2.imwrite('images/combined_threshold_75.jpg', combined_75)
# cv2.imwrite('images/combined_threshold_100.jpg', combined_100)
# cv2.imwrite('images/combined_threshold_127.jpg', combined_127)
